...
-- Records of kvideo
-- ----------------------------
INSERT INTO `kvideo` VALUES ('0000000001', '防水处理是否需要铲除原墙体防水基层？', '/static/upload/6a77c4c5a840f626/b97488f1bc0043ff.jpg', 'fddfgfdsgdfgdfgds 真的很不是滴啊I', '2019-05-24 14:00:57', 'https://xiao.moznet.cn/SHILOWAJY3.mp4');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=276 DEFAULT CHARSET=utf8 COMMENT='系统操作日志表';
...
INSERT INTO `system_log` VALUES ('275', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-05-24 17:53:21');
...
) ENGINE=InnoDB AUTO_INCREMENT=195 DEFAULT CHARSET=utf8 COMMENT='系统菜单表';
...
INSERT INTO `system_menu` VALUES ('186', '117', '空间榜样视频', '', 'fa fa-film', '#', '', '_self', '0', '1', '0', '2019-05-18 11:41:00');
INSERT INTO `system_menu` VALUES ('187', '186', '空间视频列表', '', 'fa fa-creative-commons', 'tuanj/kvideo/index', '', '_self', '0', '1', '0', '2019-05-18 11:41:48');
...
INSERT INTO `system_menu` VALUES ('194', '118', '首页装修攻略轮播图', '', 'fa fa-bookmark-o', 'tuanj/save/index', '', '_self', '0', '1', '0', '2019-05-24 13:39:06');
...
INSERT INTO `yuyue` VALUES ('0000000102', '预选节目样板间', '张翠山', '18672536008', '恒大世纪广场', '150', null, null, null, '2019-05-24 17:34:45', null, null, null);
INSERT INTO `yuyue` VALUES ('0000000103', '申请免费平面方案', '展示柜三丰', '18672569933', '', '', null, null, null, '2019-05-24 17:36:55', null, null, null);
