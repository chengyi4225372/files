...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=308 DEFAULT CHARSET=utf8 COMMENT='系统操作日志表';
...
INSERT INTO `system_log` VALUES ('289', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-04-13 14:25:20');
INSERT INTO `system_log` VALUES ('290', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-04-13 14:34:08');
INSERT INTO `system_log` VALUES ('291', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-04-13 14:35:01');
INSERT INTO `system_log` VALUES ('292', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-04-13 16:47:19');
INSERT INTO `system_log` VALUES ('293', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-04-13 18:06:51');
INSERT INTO `system_log` VALUES ('294', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-04-15 10:18:56');
INSERT INTO `system_log` VALUES ('295', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-04-15 11:22:10');
INSERT INTO `system_log` VALUES ('296', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-04-15 16:12:42');
INSERT INTO `system_log` VALUES ('297', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-04-16 09:19:56');
INSERT INTO `system_log` VALUES ('298', '116.21.134.189', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-04-17 14:05:53');
INSERT INTO `system_log` VALUES ('299', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-05-07 16:49:12');
INSERT INTO `system_log` VALUES ('300', '113.109.199.5', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-05-09 10:32:56');
INSERT INTO `system_log` VALUES ('301', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-05-09 13:24:22');
INSERT INTO `system_log` VALUES ('302', '223.192.192.123', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-05-10 11:58:02');
INSERT INTO `system_log` VALUES ('303', '67.229.136.123', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-05-11 10:00:44');
INSERT INTO `system_log` VALUES ('304', '67.229.78.78', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-05-16 18:25:34');
INSERT INTO `system_log` VALUES ('305', '223.192.192.27', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-05-16 18:27:47');
INSERT INTO `system_log` VALUES ('306', '67.229.78.78', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-05-18 09:42:05');
INSERT INTO `system_log` VALUES ('307', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-05-28 09:38:01');
...
INSERT INTO `system_menu` VALUES ('157', '156', 'Company(公司简介)', '', 'fa fa-calendar-o', '/tuanj/about/index', '', '_self', '0', '1', '0', '2019-02-15 11:57:08');
...
-- Records of video
-- ----------------------------
INSERT INTO `video` VALUES ('0000000002', '/static/upload/778c5b8d219a06b9/bad75b09a333f3db.mp4', '2019-05-11 10:49:10');
