...
-- Records of contact
-- ----------------------------
INSERT INTO `contact` VALUES ('0000000001', 'zhangwuji ', '732345907@qq.com', '186725558999', '张三丰', '2019-03-16 11:35:25');
INSERT INTO `contact` VALUES ('0000000006', '张无忌', '448164738@qq.com', '18672536699', 'w我的手机屏碎了，然后也听不到声音了。', '2019-03-20 09:49:56');
...
CREATE TABLE `order_list` (
  ...
  `phone` varchar(255) NOT NULL COMMENT '手机型号',
  `price` decimal(10,2) unsigned NOT NULL COMMENT '维修价格',
  `issue` varchar(255) NOT NULL COMMENT '诊断类型',
  `date` varchar(100) NOT NULL COMMENT '预约时间',
  `time` varchar(100) NOT NULL COMMENT '预约维修时间',
  `state` varchar(255) NOT NULL COMMENT '预约地区',
  `store` varchar(255) NOT NULL COMMENT '预约店铺',
  `screen` varchar(255) NOT NULL COMMENT '屏幕类型',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '提交订单时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `order_list` VALUES ('0000000010', '东方不败', '732907@qq.com', 'iphone xmar', '200.00', '充电口', '30-03-2019', '', '上海', '陆家嘴225号', 'OEM', '2019-03-29 17:42:17');
INSERT INTO `order_list` VALUES ('0000000005', '张无忌', '463031955@qq.com', 'iphone xmar', '200.00', '充电口', '30-03-2019', '', '北京', '西直门东大街11号', 'Generic', '2019-03-29 16:27:20');
INSERT INTO `order_list` VALUES ('0000000006', 'hhahah', '732345907@qq.com', 'iphone xmar', '200.00', '充电口', '31-03-2019', '', '广州', '广州我不熟11号', 'Generic', '2019-03-29 16:27:57');
INSERT INTO `order_list` VALUES ('0000000007', 'hhahah', '732345907@qq.com', 'iphone xmar', '200.00', '充电口', '31-03-2019', '', '广州', '广州我不熟11号', 'Generic', '2019-03-29 16:28:03');
INSERT INTO `order_list` VALUES ('0000000008', '归海一刀', '4494849@qq.com', 'iphone xmar', '200.00', '充电口', '31-03-2019', '', '上海', '陆家嘴225号', 'Generic', '2019-03-29 16:44:38');
INSERT INTO `order_list` VALUES ('0000000009', '柳生但马守', '5454645@qq.com', 'iphone xmar', '200.00', '充电口', '30-03-2019', '', '北京', '西直门东大街11号', 'Generic', '2019-03-29 16:58:08');
...
CREATE TABLE `phone_models` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `models` varchar(255) NOT NULL COMMENT '手机对应的型号',
  `pid` int(255) unsigned NOT NULL COMMENT '手机名称关联手机型号',
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='手机型号表';

-- ----------------------------
-- Records of phone_models
-- ----------------------------
INSERT INTO `phone_models` VALUES ('0000000001', 'iphone xmar', '1', '2019-03-16 15:44:57');
INSERT INTO `phone_models` VALUES ('0000000002', 'iphone x', '1', '2019-03-16 16:53:35');
INSERT INTO `phone_models` VALUES ('0000000003', 'iphone xr', '1', '2019-03-16 16:53:50');
INSERT INTO `phone_models` VALUES ('0000000004', '红米1', '2', '2019-03-16 16:55:01');
INSERT INTO `phone_models` VALUES ('0000000005', '红米2', '2', '2019-03-16 16:55:12');
INSERT INTO `phone_models` VALUES ('0000000006', 'OPPO x7', '3', '2019-03-16 16:55:32');
INSERT INTO `phone_models` VALUES ('0000000007', 'x6', '3', '2019-03-16 16:55:42');

-- ----------------------------
-- Table structure for `phone_money`
-- ----------------------------
DROP TABLE IF EXISTS `phone_money`;
CREATE TABLE `phone_money` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `pid` int(10) unsigned NOT NULL COMMENT '手机品牌id',
  `mid` int(10) unsigned NOT NULL COMMENT '手机型号id',
  `cid` int(10) unsigned NOT NULL COMMENT '诊断类型id',
  `money` varchar(100) NOT NULL COMMENT '报价金额',
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of phone_money
-- ----------------------------
INSERT INTO `phone_money` VALUES ('0000000001', '1', '1', '1', '200', '2019-03-16 16:43:27');
INSERT INTO `phone_money` VALUES ('0000000002', '2', '5', '1', '100', '2019-03-16 16:56:07');
INSERT INTO `phone_money` VALUES ('0000000003', '3', '7', '1', '500', '2019-03-16 16:56:24');

-- ----------------------------
-- Table structure for `phone_pai`
-- ----------------------------
DROP TABLE IF EXISTS `phone_pai`;
CREATE TABLE `phone_pai` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `pai` varchar(200) NOT NULL COMMENT '手机品牌',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='手机品牌表';

-- ----------------------------
-- Records of phone_pai
-- ----------------------------
INSERT INTO `phone_pai` VALUES ('0000000001', 'iphone');
INSERT INTO `phone_pai` VALUES ('0000000002', 'xiaomi');
INSERT INTO `phone_pai` VALUES ('0000000003', 'oppo');
...
CREATE TABLE `state` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `names` varchar(200) NOT NULL COMMENT '所在地区',
...
-- Records of state
-- ----------------------------
INSERT INTO `state` VALUES ('0000000001', '北京', '2019-03-16 17:08:38');
INSERT INTO `state` VALUES ('0000000002', '上海', '2019-03-16 17:08:49');
INSERT INTO `state` VALUES ('0000000003', '广州', '2019-03-16 17:08:57');
...
CREATE TABLE `store` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `sid` int(10) unsigned NOT NULL COMMENT '地区id',
  `names` varchar(200) NOT NULL COMMENT '商店名称',
  `time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
-- Records of store
-- ----------------------------
INSERT INTO `store` VALUES ('0000000001', '1', '西直门东大街11号', '2019-03-16 17:17:58');
INSERT INTO `store` VALUES ('0000000002', '2', '陆家嘴225号', '2019-03-16 17:18:30');
INSERT INTO `store` VALUES ('0000000003', '3', '广州我不熟11号', '2019-03-16 17:19:37');
INSERT INTO `store` VALUES ('0000000004', '4', '哈哈哈11号', '2019-03-16 17:20:00');
INSERT INTO `store` VALUES ('0000000005', '1', '新街口115号', '2019-03-16 17:20:19');
INSERT INTO `store` VALUES ('0000000006', '1', '永清街202号', '2019-03-16 17:20:40');
INSERT INTO `store` VALUES ('0000000007', '1', '清河大街225号', '2019-03-16 17:21:03');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=248 DEFAULT CHARSET=utf8 COMMENT='系统操作日志表';
...
INSERT INTO `system_log` VALUES ('235', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-15 09:59:46');
INSERT INTO `system_log` VALUES ('236', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-15 10:15:08');
INSERT INTO `system_log` VALUES ('237', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-15 14:08:09');
INSERT INTO `system_log` VALUES ('238', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-15 15:28:09');
...
INSERT INTO `system_log` VALUES ('244', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-19 09:11:16');
INSERT INTO `system_log` VALUES ('245', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-20 09:50:10');
INSERT INTO `system_log` VALUES ('246', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-23 09:20:51');
INSERT INTO `system_log` VALUES ('247', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-29 15:31:33');
...
INSERT INTO `system_menu` VALUES ('139', '117', '联系我们', '', '', '#', '', '_self', '0', '1', '0', '2019-03-15 11:22:05');
INSERT INTO `system_menu` VALUES ('140', '139', '联系我们列表', '', '', '/tuanj/contact/index', '', '_self', '0', '1', '0', '2019-03-15 11:22:30');
INSERT INTO `system_menu` VALUES ('141', '117', '自我诊断', '', '', '#', '', '_self', '0', '1', '0', '2019-03-15 18:19:28');
INSERT INTO `system_menu` VALUES ('142', '141', '诊断类型', '', '', '/tuanj/zhengcates/index', '', '_self', '0', '1', '0', '2019-03-15 18:20:07');
INSERT INTO `system_menu` VALUES ('143', '141', '诊断详情内容', '', '', 'tuanj/zhenginfo/index', '', '_self', '0', '1', '0', '2019-03-15 18:26:29');
INSERT INTO `system_menu` VALUES ('144', '117', '手机设置', '', '', '#', '', '_self', '0', '1', '0', '2019-03-16 15:17:37');
INSERT INTO `system_menu` VALUES ('145', '144', '手机品牌', '', '', '/tuanj/phonepai/index', '', '_self', '0', '1', '0', '2019-03-16 15:18:12');
INSERT INTO `system_menu` VALUES ('146', '144', '手机型号', '', '', '/tuanj/phonemodels/index', '', '_self', '0', '1', '0', '2019-03-16 15:18:39');
INSERT INTO `system_menu` VALUES ('147', '144', '手机诊断报价', '', '', '/tuanj/phonemoney/index', '', '_self', '0', '1', '0', '2019-03-16 15:30:58');
INSERT INTO `system_menu` VALUES ('148', '117', '地区及商店设置', '', '', '#', '', '_self', '0', '1', '0', '2019-03-16 16:57:33');
INSERT INTO `system_menu` VALUES ('149', '148', '设置地区', '', '', '/tuanj/state/index', '', '_self', '0', '1', '0', '2019-03-16 16:58:13');
INSERT INTO `system_menu` VALUES ('150', '148', '所在地区商店', '', '', '/tuanj/store/index', '', '_self', '0', '1', '0', '2019-03-16 16:58:37');
INSERT INTO `system_menu` VALUES ('151', '117', '订单管理', '', '', '#', '', '_self', '0', '1', '0', '2019-03-29 15:32:57');
INSERT INTO `system_menu` VALUES ('152', '151', '订单列表', '', '', '/tuanj/orderlist/index', '', '_self', '0', '1', '0', '2019-03-29 15:33:27');
...
-- ----------------------------
-- Table structure for `zhenduan`
-- ----------------------------
DROP TABLE IF EXISTS `zhenduan`;
CREATE TABLE `zhenduan` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL COMMENT '诊断类型标题',
  `content` varchar(255) NOT NULL COMMENT '诊断内容',
  `nid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '诊断类型名称关联诊断标题',
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
-- Records of zhenduan
-- ----------------------------
INSERT INTO `zhenduan` VALUES ('0000000003', '带罗纹地毯插件和刷条', '<p>45644655</p>', '1', '2019-03-16 15:16:37');

-- ----------------------------
-- Table structure for `zhen_title`
-- ----------------------------
DROP TABLE IF EXISTS `zhen_title`;
...
-- ----------------------------
INSERT INTO `zhen_title` VALUES ('0000000001', '充电口', '30', '2019-03-23 09:22:01');
INSERT INTO `zhen_title` VALUES ('0000000002', '电池', '0', '2019-03-18 14:26:38');
INSERT INTO `zhen_title` VALUES ('0000000003', '电池', '30', '2019-03-23 09:22:17');
INSERT INTO `zhen_title` VALUES ('0000000004', 'Screen / Display', '50', '2019-03-29 16:54:45');
